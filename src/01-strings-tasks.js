...
function encodeToRot13(str) {
  ...
  const arr2 = [];
  arr.forEach((element) => {
    const charNum = element.charCodeAt();
    if (charNum >= 65 && charNum <= 77) {
      arr2.push(String.fromCharCode(charNum + 13));
...
function isString(value) {
  return Object.prototype.isPrototypeOf.call(String.prototype, value) || typeof value === 'string';
}
